...
_TESTOPTIONALFIELDSATEND = descriptor.Descriptor(
  name='TestOptionalFieldsAtEnd',
  full_name='TestOptionalFieldsAtEnd',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    descriptor.FieldDescriptor(
      name='first_value', full_name='TestOptionalFieldsAtEnd.first_value', index=0,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='second_value', full_name='TestOptionalFieldsAtEnd.second_value', index=1,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='third_value', full_name='TestOptionalFieldsAtEnd.third_value', index=2,
      ...
      options=None),
    descriptor.FieldDescriptor(
      name='fourth_value', full_name='TestOptionalFieldsAtEnd.fourth_value', index=3,
...
DESCRIPTOR.message_types_by_name['TestOptionalFieldsAtEnd'] = _TESTOPTIONALFIELDSATEND
...
class TestOptionalFieldsAtEnd(message.Message):
  __metaclass__ = reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _TESTOPTIONALFIELDSATEND
  
  # @@protoc_insertion_point(class_scope:TestOptionalFieldsAtEnd)
